...
//		robot.mouseLeftClick(1275, 446);
	...
	/**
	 * 图片搜索
	 * 为提高搜索的精确度，推荐使用配套工具截图 https://github.com/xnx3/xnx3/blob/master/ScreenCapture.jar?raw=true
	 */
	public static void imageSearch(){
		...
		List<CoordBean> list1 = robot.imageSearch("d.png", Robot.SIM_BLUR_VERY);
